...
public class NextDnsDenyService extends ParallelRequestProcessor {
    ...
    public void saveDenyList(List<String> newDenylist) {
        ...
        callApi(createRequests, nextDnsDenyClient::saveDeny);
    }
    ...
    public void removeAll() {
        ...
        callApi(ids, nextDnsDenyClient::deleteDenyById);
    }
